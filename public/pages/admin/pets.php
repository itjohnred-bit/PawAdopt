...
<div class="filter-bar">
    <div class="search-input-wrap">
        ...
        <input type="text" name="search" class="form-control" placeholder="Search pets or shelters…" value="<?= htmlspecialchars($search) ?>">
    </div>
...
<table class="data-table">
    <thead><tr><th>Photo</th><th>Name</th><th>Species / Breed</th><th>Shelter</th><th>Age</th><th>Status</th><th>Posted</th><th>Actions</th></tr></thead>
    <tbody>
    ...
    <tr>
        ...
        <td><?= sanitize($pet['shelter_name']) ?><?= $pet['shelter_city']?' · '.sanitize($pet['shelter_city']):'' ?></td>
